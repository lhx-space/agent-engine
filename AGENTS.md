...
**已可插拔**：LLM / 搜索 / 沙箱 / MCP / Skills / Tools / Plugin / MemoryBackend / CacheBackend / VectorStore / EmbeddingProvider / events 总线 / 流式 `custom` 事件 / Human-in-the-loop 审批。
